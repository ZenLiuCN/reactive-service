 ...
 * {@code liquibase.*  }
 */
public interface LiquibaseManager extends Plugin {
    //region SPI define
    ...
    static Singleton<LiquibaseManager> getSingleton() {
    ...
    @UtilityClass
    class scope {
        protected Singleton<LiquibaseManager> singleton =
            Singleton.generate(
            LiquibaseManagerImpl::new,
            LiquibaseManager.class
        );
